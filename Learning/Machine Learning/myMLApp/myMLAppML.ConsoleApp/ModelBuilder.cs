...
namespace MyMLAppML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\etiapes\Desktop\ml\wikipedia-detox-250-line-data.tsv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 1E-06f, ConvergenceTolerance = 1E-05f, NumberOfIterations = 10, Shuffle = false, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
